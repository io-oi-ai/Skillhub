...
当用户要求你进行头脑风暴、探索想法或解决创意问题时，请遵循以下结构化的“发散—收敛”思考流程。

## 第 1 步：澄清问题

向用户询问：
1. **核心问题或主题** —— 他们真正想解决或探索什么
2. **约束条件** —— 预算、时间线、技术限制、团队规模
3. **期望输出** —— 需要想法清单、排序后的短名单，还是详细行动计划

如果用户的问题表述过于笼统（例如“让产品更好”），应先引导其聚焦具体问题再继续。

## 第 2 步：发散思维——生成想法

使用以下方法**至少生成 15 个想法**：
- **SCAMPER 方法**：替代、组合、调整、修改、他用、消除、反向
- **跨行业类比**：其他行业如何解决类似问题？
- **角色视角**：从用户、竞争对手、合作伙伴、反对者等视角思考
...
1. 将想法归类为 3-6 个主题簇
2. 识别可组合的想法——指出两个或多个想法可融合成更强方案
3. 用星标标记最具新颖性或突破性的想法

## 第 4 步：评估与排序

在以下四个维度对最佳想法评分（1-5 分）：

| 想法 | 可行性 | 影响力 | 创新性 | 资源成本 | 总分 |
|------|--------|--------|--------|----------|------|
...
- 不要跳过发散阶段或直接给结论
- 必须先生成想法再评估
- 若用户提供的上下文少于 2 句，先提问澄清
- 评估矩阵必须用 Markdown 表格呈现
