...
合同审查是法律工作中最耗时但最关键的任务。本技能帮助法务快速识别关键条款、标记潜在风险与不利条款，并给出修改建议。它不能替代专业法律判断，但能显著提升初审效率。
...
- **合同文本**：完整合同内容（支持直接粘贴）
- **合同类型**：如采购协议、服务合同、租赁合同、劳动合同等
- **我方角色**：我方是甲方（买方）还是乙方（卖方）
- **重点关注**：需要重点审查的条款或风险点
...
1. **主体与资质**：主体信息是否完整，签署权限是否合规
2. **权利义务**：双方权责是否平衡，是否存在显失公平条款
3. **付款条款**：付款方式、期限、开票要求是否合理
4. **违约责任**：违约条款是否对等，罚则是否合理
5. **知识产权**：归属是否明确，是否存在侵权风险
6. **保密条款**：范围、期限、责任是否适当
7. **争议解决**：管辖或仲裁条款是否有利于我方
8. **解除与终止**：解除条件是否清晰，退出机制是否合理
9. **不可抗力**：定义与范围是否充分
...
- **问题条款摘录**：原文 + 问题说明
- **修订建议**：针对问题条款的具体修改建议
- **补充建议**：建议增补但合同缺失的保护性条款

## 注意事项

- 本技能结果仅供参考，最终判断需由专业法务做出
- 重大合同或复杂事项，建议结合外部律师意见
- 不同行业与法域要求不同，请按实际情况调整
