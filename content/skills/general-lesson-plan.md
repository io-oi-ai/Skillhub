...
优秀的教案是高质量课程的基础。本技能根据学习目标、学生水平与课程时长，帮助教育者设计结构完整、互动性强的课程教案。适用于学校课堂、企业培训与线上课程等场景。
...
3. **教学过程设计**：按时间轴组织教学环节
   ...
   - 巩固提升：练习题或实践任务
   - 总结回顾：知识点梳理与重点强调
4. **互动活动设计**：具体课堂互动安排与操作说明
5. **评估方案**：课堂评估、作业设计与评分标准
6. **差异化教学建议**：针对不同水平学生的调整方案
7. **教学资源清单**：推荐的辅助材料与参考资源

## 使用建议

- **目标要具体可衡量**：用“能够列举/能够分析/能够应用”等动词
- **注意节奏**：避免长时间单向讲授，每 10-15 分钟安排互动
- **预设常见问题**：提前准备学生可能提出的问题及回应
- **留有弹性**：教案是指南非剧本，可根据课堂反馈灵活调整
