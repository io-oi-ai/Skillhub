...
在招聘高峰期，HR 可能每天需要处理几十甚至上百份简历。本技能可根据职位要求对候选人简历进行自动筛选与评估，产出结构化评估结果与候选人对比分析，帮助你将精力聚焦在真正合适的候选人上。
...
- **岗位描述（JD）**：完整的岗位职责与要求
- **候选人简历**：一份或多份简历
- **硬性要求**：学历、年限、必须具备的技能等不可妥协条件
- **加分项**：优选但非必须的条件，如行业经验、项目经历
- **薪资范围**：若有明确预算，有助于判断预期匹配度

## 评估维度

简历将从以下维度进行评分：

1. **基础匹配度**：学历、年限、地点等硬性要求是否满足
2. **技能匹配度**：技能与岗位要求的契合度
3. **行业经验**：相关行业经验与项目积累
4. **职业发展路径**：跳槽频率、角色变迁、成长趋势
5. **项目成果**：量化成果与绩效亮点
6. **稳定性评估**：基于跳槽频率与职业路径的稳定性

## 输出内容

- **候选人评级**：A（强烈推荐）、B（建议面试）、C（待定）、D（不匹配）
- **核心优势**：每位候选人 2-3 个优势点
- **潜在风险**：面试需进一步确认的问题
- **对比分析表**：多候选人对比矩阵
- **面试建议**：针对每位候选人的面试关注点
...
- **JD 越清晰越好筛**：模糊 JD 会导致筛选标准不清
- **分批处理**：每次 5-10 份简历最佳，便于横向比较
- **权重灵活调整**：根据招聘紧急程度调整硬/软条件权重
- **不只看简历**：简历评估只是第一步，软技能仍需面试验证

## 注意事项

- 结果仅供参考，避免完全依赖自动判断做出录用决策
- 注意公平性，避免年龄/性别等非岗位因素偏见
- 简历可能存在夸大，关键内容需面试核实
