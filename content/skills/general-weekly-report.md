...
周报是职场最常见的工作汇报形式，但很多人花大量时间写周报却抓不到重点。本技能可基于一周内的工作记录、会议纪要与项目进展，快速生成结构清晰、重点突出的周报。

## 输入要求

使用本技能时请准备：

- **本周已完成工作**：本周处理的主要任务、项目名称、完成状态
- **会议纪要/沟通记录**：重要会议内容与决策
- **问题与阻碍**：工作中的困难、风险点与当前处理状态
- **下周工作计划**：已确认的下周行动项及优先级
- **需要协调的资源**：跨部门协作或管理层支持需求

信息越具体，报告质量越高。建议养成每日简单记录的习惯，周报会更轻松。

## 输出格式

生成周报包含以下结构：

1. **本周工作概览**：2-3 句概括核心产出
2. **关键工作进展**：按项目/模块列出完成情况与关键结果
3. **问题与风险**：遇到的问题及影响范围
4. **数据与成果**：量化结果，如完成率、修复 bug 数等
5. **下周计划**：按优先级列出行动项
6. **需要支持**：需要协调或决策的事项

## 使用建议

- **强调结果而非过程**：用结果导向语言描述“完成了什么”
- **数据量化**：尽可能用数字说明产出
- **控制篇幅**：周报不是流水账，控制在 1 页内
- **保持一致性**：每周用同一结构，便于对比与复盘
- **提前准备素材**：每天花 1 分钟记录要点，周报更高效
