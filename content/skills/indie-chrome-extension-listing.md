...
发布 Chrome 扩展到 Chrome Web Store 需要准备大量文案，包括名称、描述、隐私政策、截图说明等。很多独立开发者在技术完成后卡在文案阶段。本技能帮助一次性生成完整上架材料，并提示常见审核注意点以提升通过率。

## 输入要求

请提供以下信息：

- **扩展功能描述**：扩展做什么，核心功能是什么
- **目标用户**：谁会使用，解决什么问题
- **核心功能**：3-5 个主要功能点
- **权限需求**：需要哪些浏览器权限（如 activeTab、storage、tabs 等）
- **数据处理**：是否收集用户数据，数据如何存储与传输
- **竞品信息**（可选）：类似扩展与差异点
...
- **权限过多**：仅申请必要权限，避免 `<all_urls>`
- **描述与功能不符**：避免夸大宣传，确保描述真实
- **缺少隐私政策**：使用远程服务或收集数据必须提供
- **商标侵权**：名称与描述避免使用其他品牌商标
- **单一目的原则**：扩展应有明确且单一的用途
- **用户数据安全**：涉及敏感数据需加密传输

## 使用建议

- **先确认权限再写文案**：权限影响隐私政策与描述
- **SEO 优化**：自然融入用户常搜关键词
- **保持真实**：审核会实际测试，夸大易被拒
- **截图准备**：建议 1280x800 或 640x400，突出功能
- **考虑国际化**：面向全球用户可准备英文版本
